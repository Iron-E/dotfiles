...
--- configure heirline.
---
--- heirline throws a fit when configured before vim is entered.
--- so I must check if it is entered before configuring, and if not
...
local function config_heirline()
	...
	do
		...
		vim.api.nvim_create_autocmd("BufEnter", {
			desc = "Propagate BufEnterOrGitSignsUpdate",
			group = group,
			command = command,
		})
