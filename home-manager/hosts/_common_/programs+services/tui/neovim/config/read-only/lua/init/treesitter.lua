...
---@param ft string
---@param winid integer
local function ts_buf_enable(bufnr, ft, winid)
...
vim.api.nvim_create_autocmd('FileType', {
	...
	callback = function(ev)
		ts_buf_enable(ev.buf, ev.match, vim.api.nvim_get_current_win())
	end,
})
