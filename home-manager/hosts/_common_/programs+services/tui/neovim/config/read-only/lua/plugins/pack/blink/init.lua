...
opts.completion.menu.draw.components.kind = {
	highlight = opts.completion.menu.draw.components.kind_icon.highlight,
}

opts.sources.per_filetype.markdown = opts.sources.per_filetype.latex
opts.sources.per_filetype.mysql = opts.sources.per_filetype.sql
opts.sources.per_filetype.plsql = opts.sources.per_filetype.sql
