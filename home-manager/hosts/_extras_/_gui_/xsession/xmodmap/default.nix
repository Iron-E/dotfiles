...
in {
	...
	let
		...
		delim: # the value to put in the middle of `twice`
			let list = twoOf value;
			in lib.intersperse delim list
		;
		...
		value:
		valueAfter:
			(sixOf value) ++ (lib.toList valueAfter)
		;
		...
		common = {
			...
			"10" = twoOf [1 "exclam"];
			"11" = twoOf [2 "at"];
			"12" = twoOf [3 "numbersign"];
			"13" = twoOf [4 "dollar"];
			"14" = twoOf [5 "percent"];
			"15" = twoOf [6 "asciicircum"];
			"16" = twoOf [7 "ampersand"];
			"17" = twoOf [8 "asterisk"];
			"18" = twoOf [9 "parenleft"];
			"19" = twoOf [0 "parenright"];
			"20" = twoOf ["minus" "underscore"];
			"21" = twoOf ["equal" "plus"];
			"22" = twoOf ["BackSpace" "BackSpace"];
			"23" = twoOf ["Tab" "ISO_Left_Tab"];
			"24" = twoOf ["q" "Q"];
			"25" = twoOf ["w" "W"];
			"26" = (twoOf ["e" "E"]) ++ (inTwoOf "EuroSign" "NoSymbol");
			"27" = twoOf ["r" "R"];
			"28" = twoOf ["t" "T"];
			"29" = twoOf ["y" "Y"];
			"30" = twoOf ["u" "U"];
			...
			"32" = twoOf ["o" "O"];
			"33" = twoOf ["p" "P"];
			"34" = twoOf ["bracketleft" "braceleft"];
			"35" = twoOf ["bracketright" "braceright"];
			...
			"45" = twoOf ["k" "K"];
			"46" = twoOf ["l" "L"];
			"47" = twoOf ["semicolon" "colon"];
			"48" = twoOf ["apostrophe" "quotedbl"];
			"49" = twoOf ["grave" "asciitilde"];
			"50" = inTwoOf "Shift_L" "NoSymbol";
			"51" = twoOf ["backslash" "bar"];
			"52" = twoOf ["z" "Z"];
			"53" = twoOf ["x" "X"];
			"54" = twoOf ["c" "C"];
			"55" = twoOf ["v" "V"];
			...
			"58" = twoOf ["m" "M"];
			"59" = twoOf ["comma" "less"];
			"60" = twoOf ["period" "greater"];
			"61" = twoOf ["slash" "question"];
			"62" = inTwoOf "Shift_R" "NoSymbol";
			"63" = sixOfThen "KP_Multiply" "XF86ClearGrab";
			"64" = twoOf ["Alt_L" "Meta_L"];
			...
			"79" = twoOf ["KP_Home" "KP_7"];
			"80" = twoOf ["KP_Up" "KP_8"];
			"81" = twoOf ["KP_Prior" "KP_9"];
			"82" = sixOfThen "KP_Subtract" "XF86Prev_VMode";
			"83" = twoOf ["KP_Left" "KP_4"];
			"84" = twoOf ["KP_Begin" "KP_5"];
			"85" = twoOf ["KP_Right" "KP_6"];
			"86" = sixOfThen "KP_Add" "XF86Next_VMode";
			"87" = twoOf ["KP_End" "KP_1"];
			"88" = twoOf ["KP_Down" "KP_2"];
			"89" = twoOf ["KP_Next" "KP_3"];
			"90" = twoOf ["KP_Insert" "KP_0"];
			"91" = twoOf ["KP_Delete" "KP_Decimal"];
			...
			"107" = twoOf ["Print" "Sys_Req"];
			"108" = twoOf ["Alt_R" "Meta_R"];
			...
			"127" = twoOf ["Pause" "Break"];
			"128" = inTwoOf "XF86LaunchA" "NoSymbol";
			"129" = twoOf ["KP_Decimal" "KP_Decimal"];
			...
			"170" = twoOf ["XF86Eject" "XF86Eject"];
			"171" = inTwoOf "XF86AudioNext" "NoSymbol";
			"172" = twoOf ["XF86AudioPlay" "XF86AudioPause"];
			"173" = inTwoOf "XF86AudioPrev" "NoSymbol";
			"174" = twoOf ["XF86AudioStop" "XF86Eject"];
			...
			"204" = twoOf ["NoSymbol" "Alt_L"];
			"205" = twoOf ["NoSymbol" "Meta_L"];
			"206" = twoOf ["NoSymbol" "Super_L"];
			"207" = twoOf ["NoSymbol" "Hyper_L"];
	...
	in {
		".Xmodmap".text = util.generators.toXmodmap (common // {
